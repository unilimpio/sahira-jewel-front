...
import HeartIcon from "../../components/common/template/icons/HeartIcon"
...
export default function WishlistComponent({className, iconClassName}) {
  ...
  return (
    <div className={""}>
      <button
        ...
        className={`  ${className}`}
      >
        <HeartIcon className={`${className}`} iconClassName={`${iconClassName}`} />
      </button>
